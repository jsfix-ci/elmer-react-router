...
var ElmerReactRouter = function (_Component) {
    ...
    function ElmerReactRouter(props) {
        ...
        var keys = Object.keys(props.pages);
        var cKeys = object.keys(props.statePages);
        if (props.debug) {
    ...
    _createClass(ElmerReactRouter, [{
        ...
        value: function getPage() {
            ...
            var result = statePages[pageKey] || pages[pageKey];
        ...
        value: function render() {
            ...
            var properties = _extends({}, this.props, {
                lang: lang,
                route: this.route
            });
            return _react2.default.createElement(PageData, properties);
        }
    }]);
...
ElmerReactRouter.propTypes = {
    ...
    statePages: _propTypes2.default.object.isRequired,
